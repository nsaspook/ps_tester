...
//166116/122786/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "OP213FSZ" (originalName "OP213FSZ")
	...
	(compDef "OP213FSZ" (originalName "OP213FSZ") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "OP213FSZ"))
		...
		(attr "Mouser Part Number" "584-OP213FSZ")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Analog-Devices/OP213FSZ?qs=WIvQP4zGanht4Vig9f9CDQ%3D%3D")
		(attr "Manufacturer_Name" "Analog Devices")
		(attr "Manufacturer_Part_Number" "OP213FSZ")
		(attr "Description" "OP213FSZ")
		(attr "<Hyperlink>" "https://datasheet.datasheetarchive.com/originals/distributors/SFDatasheet-4/sf-00085565.pdf")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "OP213FSZ.stp")
